 ...
 *     INKSTAND_RECENT_ENTRY_MAX so a note can copy the entry it was handed before anything moves:
...
#define INKSTAND_RECENT_ENTRY_MAX 256U
...
typedef bool (*inkstand_recent_same_fn)(const void *entry, const void *wanted, void *context);

struct inkstand_recent {
...
typedef int (*inkstand_recent_write_fn)(FILE *out, const void *entry, void *context);
...
typedef bool (*inkstand_recent_parse_fn)(const char *text, size_t len, void *entry, void *context);
